...
var Icon$I = function (props) {
    return (
        // React.createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$N, { width: "24px", color: "IconColor" })) : (React.createElement(Icon$M, { width: "24px", color: "IconColor" }))),
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/dragoneggfarm",
                target: '_blank',
            },
            {
                label: "Docs",
            ...
            {
                label: "Blog",
                href: "https://dragoneggfarm.medium.com",
                target: '_blank',
            },
        ],
    },
...
var socials = [
    ...
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/Dragonswap_app",
        target: '_blank',
    },
];
var MENU_HEIGHT = 64;
...
var CustomLinkLabel = styled.div`
    font-size:20px;
    color:#FFFFFF;
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        var iconElement = React.createElement(Icon, { width: "0px", mr: "0px" });//24,8
        ...
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            (entry.label==="Whitepaper") ? React.createElement(MenuLink, { href: entry.href,target:"_blank", onClick: handleClick }, iconElement, React.createElement(LinkLabel, { isPushed: isPushed }, entry.label)):
            (entry.label === "DRAGONSWAP") ? React.createElement(MenuLink, { href: entry.href, onClick: handleClick }, iconElement, React.createElement(CustomLinkLabel, { isPushed: isPushed }, entry.label))
            :React.createElement(MenuLink, { href: entry.href, onClick: handleClick }, iconElement, React.createElement(LinkLabel, { isPushed: isPushed }, entry.label))));
    })));
};
var templateObject_1$B;
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/0x105b81a13ECBb92773a7b9854D125Cb7478b8340", target: "_blank" },
                React.createElement(Icon$w, { width: "24px", mr: "8px" }),
                React.createElement(Text, { color: "contrasttitle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
            React.createElement(Flex, null, socials.map(function (social, index) {
                var Icon = Icons$1[social.icon];
                var iconProps = { width: "24px", color: "contrasttitle", style: { cursor: "pointer" } };
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.pizzaPriceUsd, links = _a.links, profile = _a.profile, children = _a.children;
...
// } });
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", contrasttitle: "#2d6eb6", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#2d6eb6", textDisabled: "#BDC2C4", textSubtle: "#2d6eb6", borderColor: "#E9EAEB", panel: "#faf9fa", iconColor : "#2d6eb6", card: "#eaeded", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
...
//     } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#11162d", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", contrasttitle: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#2d6eb6", textDisabled: "#666171", textSubtle: "#FFFFFF", borderColor: "#524B63", panel: "#11162d", iconColor : "#2d6eb6", card: "#000000", gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
...
var light$1 = (_a$2 = {},
    ...
    _a$2[SECONDARY] = {
        ...
        borderColorHover: lightColors.buttonhover,
        boxShadow: "none",
