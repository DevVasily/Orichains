    ...
    <Card isActive={isCardActive} isFinished={isFinished && pastaId !== 0}>
      ...
      <div style={{ padding: '24px' }}>
        ...
        <div style={{ marginBottom: '8px', display: 'flex', alignItems: 'center' }}>
          {account && (<div style={{ flex: 1 }}> 
            <Image src={`/images/tokens/${image || tokenName}.png`} width={64} height={64} alt={tokenName} />
          </div>
          )}
          {!account && (<div style={{ margin:'auto'}}>            
          <img src={`/images/tokens/${image || tokenName}.png`} width={64} height={64} alt={tokenName} />
          </div>
          )}
        ...
        {!isOldPasta ? (
          <BalanceAndCompound>
            {!account && (<div style={{textAlign:'center', width: '100%'}}><Balance value={getBalanceNumber(earnings, tokenDecimals)} isDisabled={isFinished} /></div>)}
            {account && <Balance value={getBalanceNumber(earnings, tokenDecimals)} isDisabled={isFinished} />}
        ...
        {account && <Label isFinished={isFinished && pastaId !== 0} text={TranslateString(330, `${earnToken} earned`)} />}
        {!account && (<div style={{textAlign:'center'}}><Label isFinished={isFinished && pastaId !== 0} text={TranslateString(330, `${earnToken} earned`)} /></div>)}
        <StyledCardActions>
        ...
        <StyledDetails>
          <div style={{ flex: 1, color:'#2d6eb6' }}>{TranslateString(352, 'APY')}:</div>
